...
class AstraForwardProjector3D_cupy(DataProcessor_cupy):
    ...
    def __init__(self,
        ...
        super(AstraForwardProjector3D_cupy, self).__init__(**kwargs)
    ...
    def process(self, out=None):
        ...
        sinogram_id, DATA.array = astra.create_sino3d_gpu(cp.asnumpy(IM.as_array()), 
                                                           self.proj_geom,
                                                           self.vol_geom)
        DATA.array = cp.array(DATA.array)
