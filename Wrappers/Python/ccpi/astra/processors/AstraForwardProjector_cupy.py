...
class AstraForwardProjector_cupy(DataProcessor_cupy):
    ...
    def __init__(self,
        ...
        super(AstraForwardProjector_cupy, self).__init__(**kwargs)
    ...
    def process(self, out=None):
        ...
        sinogram_id, DATA.array = astra.create_sino(cp.asnumpy(IM.as_array()), 
                                                           self.proj_id)
